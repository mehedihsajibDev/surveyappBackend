...
<table class="table table-striped table-responsive centered">
  ...
  <tbody>
   ...
   <tr>
      ...
      {{-- <th colspan="">
         <p class="text-center text-success"> Please register only one activity per row and for the Multi-tasking please use the last column
     </th> --}}

    </tr>
    {{-- <tr>
      <th colspan="">
     <p class="text-center text-success">Before Making the first trip of the day,
please mention your time use and associated activities</p>
</th>
    </tr> --}}
    <tr>
    ...
    <tr>
     <td>
        <div>
            ...
            <div >
                <select name="ampm" class="ampm" style="padding:3px;">
    ...
    <tr>
        <td>
            ...
            <div>
                <div style="float: left;">
                    <input type="text" id="timePicker2" name="endtime">
                </div>
                <div >
                    <select name="ampm" class="ampm" style="padding:3px;">
                        <option value="Am">Am</option>
 ...
 <select class="form-select" style="font-size: 14px;" name="multitask" required>
  <optgroup class="selectfont">
    <option selected>Select Multitask Name</option>
 ...
 <select class="form-select" style="font-size: 14px;" name="copartner">
  <optgroup class="selectfont">
    ...
    <option selected>Select Copartaner Name</option>
...
<tr>
    ...
    <div class="2nd div" style="max-width: 780px;margin-bottom:50px;margin-top:-10px;" >
      <div class="container text-center" style="width: 400px;" >
        <h3 class="text-primary">Do you Have Another Activity?</h3>
      </div>
      <div class="container text-center"style="width: 400px;">
        <button class="btn btn-default" id="yesbtn"><a href="{{route('home')}}" >Yes</a> </button>
        <button class="btn btn-success" id="nobtns"><a href="{{route('home')}}"style="color: #ffff;">No</a></button>
      </div>
    </div>
